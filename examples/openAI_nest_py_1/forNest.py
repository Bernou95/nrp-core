...
neurons = nest.Create('iaf_psc_alpha',61)

for i in range(60):
    dc_name = "dc_"+ str(i)
    dc_tmp = CreateDataPack(dc_name, "dc_generator")
    nest.SetStatus(dc_tmp, {"amplitude": 0.0})
    nest.Connect(dc_tmp, neurons[i], 'all_to_all',
