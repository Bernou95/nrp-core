...
"""
activator_position = CreateDataPack("activator_position", "dc_generator", 30)
for i in range(30):
    nest.SetStatus(activator_position[i], {'amplitude':0})
activator_velocity = CreateDataPack("activator_velocity", "dc_generator", 30)
for i in range(30):
    nest.SetStatus(activator_velocity[i], {'amplitude':0})
...
# Network Connect
nest.Connect(activator_velocity, inpt_velocity, 'one_to_one')
nest.Connect(activator_position, inpt_position, 'one_to_one')
#for i in range(30):
