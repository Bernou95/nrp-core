...
TEST(TestOpensimJSONServer, TestInitError)
{
	...
	config["PythonFileName"] = TEST_OPENSIM_INIT_ERROR_FILE_NAME;
...
TEST(TestOpensimJSONServer, TestFunc)
{
	...
	config["EngineName"] = "engine";
	config["EngineType"] = "test_engine_python";
	config["PythonFileName"] = TEST_SIMPLE_OPENSIM_FILE_NAME;
	std::string server_address = "localhost:2345";
	config["ServerAddress"] = server_address;
...
TEST(TestOpensimJSONServer, TestDevice)
{
	...
	config["EngineName"] = "engine";
	config["EngineType"] = "test_engine_python";
	config["PythonFileName"] = TEST_OPENSIM_EXE_FILE_NAME;
	std::string server_address = "localhost:3456";
	config["ServerAddress"] = server_address;
