...
void handle_signal_1(int signal)
{
...
{	
    ...
    config["PythonFileName"] = TEST_OPENSIM_RUN_LOOP_FILE;
    std::string server_address = "localhost:4567";
	...
	else
	{
		try
		{
			...
			ASSERT_NE(signal(SIGHUP, &handle_signal_1), SIG_ERR);
