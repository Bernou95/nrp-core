...
@FunctionalNode("python_1", outputs=[])
...
@FromEngine(keyword='datapack_python2', address='/python_2/datapack2')
@FunctionalNode("python_2", outputs=[])
def transceiver_function(datapack_python2):
...
@FromEngine(keyword='datapack_python3', address='/python_3/datapack3')
@FunctionalNode("python_3", outputs=[])
def transceiver_function(datapack_python3):
    """Updates iteration counter for this transceiver function"""
    global num_iterations
...
@FromEngine(keyword='nest_kernel', address='/nest/kernel')
@FunctionalNode("nest", outputs=[])
def transceiver_function(nest_kernel):
    """Updates iteration counter for this transceiver function"""
    global num_iterations
