...
if("TRUE" STREQUAL "TRUE")
  set(boost_python_catkin_example_SOURCE_PREFIX /home/bernardo/8282/nrp-core/nrp_engine_protocols/nrp_rosmsg_engine_protocol/catkin_ws/src/b-python-catkin-example)
  set(boost_python_catkin_example_DEVEL_PREFIX /home/bernardo/8282/nrp-core/nrp_engine_protocols/nrp_rosmsg_engine_protocol/catkin_ws/devel)
  ...
  set(boost_python_catkin_example_INSTALL_PREFIX /home/bernardo/8282/nrp-core/nrp_engine_protocols/nrp_rosmsg_engine_protocol/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'boost_python_catkin_example' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bernardo/8282/nrp-core/nrp_engine_protocols/nrp_rosmsg_engine_protocol/catkin_ws/src/b-python-catkin-example/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT boost_python_catkin_example_NUM_DUMMY_TARGETS)
      set(boost_python_catkin_example_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::boost_python_catkin_example::wrapped-linker-option${boost_python_catkin_example_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR boost_python_catkin_example_NUM_DUMMY_TARGETS "${boost_python_catkin_example_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::boost_python_catkin_example::wrapped-linker-option${boost_python_catkin_example_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND boost_python_catkin_example_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(boost_python_catkin_example_EXPORTED_TARGETS ${${boost_python_catkin_example_dep}_EXPORTED_TARGETS})
endforeach()
