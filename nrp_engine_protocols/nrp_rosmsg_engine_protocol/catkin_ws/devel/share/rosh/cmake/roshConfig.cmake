...
if("TRUE" STREQUAL "TRUE")
  set(rosh_SOURCE_PREFIX /home/bernardo/catkin_ws/src/rosh_core/rosh)
  set(rosh_DEVEL_PREFIX /home/bernardo/catkin_ws/devel)
  set(rosh_INSTALL_PREFIX "")
  set(rosh_PREFIX ${rosh_DEVEL_PREFIX})
else()
  set(rosh_SOURCE_PREFIX "")
  set(rosh_DEVEL_PREFIX "")
  set(rosh_INSTALL_PREFIX /home/bernardo/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosh' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bernardo/catkin_ws/src/rosh_core/rosh/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT rosh_NUM_DUMMY_TARGETS)
      set(rosh_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rosh::wrapped-linker-option${rosh_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rosh_NUM_DUMMY_TARGETS "${rosh_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rosh::wrapped-linker-option${rosh_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rosh_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(rosh_EXPORTED_TARGETS ${${rosh_dep}_EXPORTED_TARGETS})
endforeach()
