...
#include "nrp_new_gazebo_engine/python/py_engine_script_wrapper.h"


namespace python = boost::python;

/*!
 * \brief Calls NewGazeboServer::registerScript() without returning a value
 */
void PyServerRegistration(python::object script)
{	NewGazeboServer::registerScript(script);	}
...
struct PyRegisterEngineDecorator
{
	...
	{	return *(NewGazeboServer::registerScript(script));	}
};
