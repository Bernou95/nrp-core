...
#ifndef NEW_GAZEBO_ENGINE_DEVICE_CONTROLLER_H
#define NEW_GAZEBO_ENGINE_DEVICE_CONTROLLER_H
...
class NewGazeboEngineDeviceController;

template<>
class NewGazeboEngineDeviceController<PyObjectDevice>
        : public EngineDeviceController<nlohmann::json, PyObjectDevice>
{
	public:
		NewGazeboEngineDeviceController(DeviceIdentifier &&devID, boost::python::object data = boost::python::object());

		virtual ~NewGazeboEngineDeviceController() override = default;
...
#endif // NEW_GAZEBO_ENGINE_DEVICE_CONTROLLER_H
