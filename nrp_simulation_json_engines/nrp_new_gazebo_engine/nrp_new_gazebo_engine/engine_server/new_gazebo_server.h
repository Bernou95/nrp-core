...
#ifndef NEW_GAZEBO_SERVER_H
#define NEW_GAZEBO_SERVER_H
...
class NewGazeboServer
        : public EngineJSONServer
{
	public:
		NewGazeboServer(const std::string &serverAddress, boost::python::dict globals, boost::python::object locals);
		NewGazeboServer(const std::string &serverAddress, const std::string &engineName, const std::string &registrationAddress, boost::python::dict globals, boost::python::object locals);
		virtual ~NewGazeboServer() override = default;
