...
#ifndef NEW_GAZEBO_SERVER_EXECUTABLE_H
#define NEW_GAZEBO_SERVER_EXECUTABLE_H
 ...
 */
class NewGazeboServerExecutable
{
	public:
		~NewGazeboServerExecutable();

		// Delete move and copy operators. This ensures this class is a singleton
		NewGazeboServerExecutable(const NewGazeboServerExecutable &) = delete;
		NewGazeboServerExecutable(NewGazeboServerExecutable &&) = delete;

		NewGazeboServerExecutable &operator=(const NewGazeboServerExecutable &) = delete;
		NewGazeboServerExecutable &operator=(NewGazeboServerExecutable &&) = delete;

		/*!
		 * \brief Get singleton instance of executable
		 * \return Returns singleton instance
		 */
		static NewGazeboServerExecutable &getInstance();
		 ...
		 * \return Returns singleton instance
		 */
		static NewGazeboServerExecutable &resetInstance(int argc, char *argv[]);
	...
	private:
		static std::unique_ptr<NewGazeboServerExecutable> _instance;

		cxxopts::ParseResult _res;

		PythonInterpreterState _pyInterp;

		NewGazeboServer _server;

		NewGazeboServerExecutable(int argc, char *argv[]);
...
#endif // NEW_GAZEBO_SERVER_EXECUTABLE_H
