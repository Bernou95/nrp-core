...
#ifndef NRP_OPENSIM_COMMUNICATION_PLUGIN_H
#define NRP_OPENSIM_COMMUNICATION_PLUGIN_H
 ...
 */
class NRPOpensimCommunicationPlugin
{
	public:
		virtual ~NRPOpensimCommunicationPlugin() = default;
