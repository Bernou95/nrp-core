...
#ifndef OPENSIM_ENGINE_SCRIPT_H
#define OPENSIM_ENGINE_SCRIPT_H
...
class OpensimEngineScript
        : public PtrTemplates<OpensimEngineScript>
{
	public:
		OpensimEngineScript() = default;
		virtual ~OpensimEngineScript();
	...
	private:
		 ...
		 */
		OpensimJSONServer *_oServer = nullptr;
...
using OpensimEngineScriptSharedPtr = OpensimEngineScript::shared_ptr;
using OpensimEngineScriptConstSharedPtr = OpensimEngineScript::const_shared_ptr;

#endif // OPENSIM_ENGINE_SCRIPT_H
