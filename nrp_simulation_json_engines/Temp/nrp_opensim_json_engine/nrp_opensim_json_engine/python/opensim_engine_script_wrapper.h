...
#ifndef OPENSIM_ENGINE_SCRIPT_WRAPPER_H
#define OPENSIM_ENGINE_SCRIPT_WRAPPER_H
 ...
 */
struct OpensimEngineScriptWrapper
        : OpensimEngineScript, boost::python::wrapper<OpensimEngineScript>
{
...
#endif // OPENSIM_ENGINE_SCRIPT_WRAPPER_H
