...
/*!
 * \brief Base class implementing a port in the computation graph
 */
class Port {
public:
     ...
     *
     * This is the number of ports this port is subscribed to in case of input ports or the number of ports subscribed to
     * this port in case of output ports
     */
...
private:
    ...
    /*!
     * \brief Dummy virtual method with the only purpose of making Port polymorphic
     */
    virtual void dummy() {}
