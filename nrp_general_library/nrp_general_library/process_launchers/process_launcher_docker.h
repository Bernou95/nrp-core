...
#ifndef PROCESS_LAUNCHER_DOCKER_H
#define PROCESS_LAUNCHER_DOCKER_H
 ...
 */
inline const char Docker[] = "Docker";

class ProcessLauncherDocker
        : public ProcessLauncher<ProcessLauncherDocker, Docker, DockerFork, EmptyLaunchCommand>
{
    public: ~ProcessLauncherDocker() override = default;
};

#endif // PROCESS_LAUNCHER_DOCKER_H
