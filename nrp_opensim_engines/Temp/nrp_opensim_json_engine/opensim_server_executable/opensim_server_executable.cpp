...
{
	this->_opensimInterp.endAllowThreads();
}
...
void OpensimServerExecutable::shutdown()
{
	if(OpensimServerExecutable::_instance != nullptr)
		OpensimServerExecutable::_instance->_opensimInterp.endAllowThreads();
...
void OpensimServerExecutable::startServerAsync()
{
	...
	this->_opensimInterp.allowThreads();
...
PythonInterpreterState &OpensimServerExecutable::opensimState()
{
	return this->_opensimInterp;
}
