...
#ifndef OPENSIM_ENGINE_JSON_DEVICE_CONTROLLER_H
#define OPENSIM_ENGINE_JSON_DEVICE_CONTROLLER_H
...
class OpensimEngineJSONDeviceController;

template<>
class OpensimEngineJSONDeviceController<PyObjectDevice>
        : public EngineDeviceController<nlohmann::json, PyObjectDevice>
{
	public:
		OpensimEngineJSONDeviceController(DeviceIdentifier &&devID, boost::python::object data = boost::python::object());

		virtual ~OpensimEngineJSONDeviceController() override = default;
		...
		/*!
		 * \brief Get opensim object referenced by this controller
		 */
...
#endif // OPENSIM_ENGINE_JSON_DEVICE_CONTROLLER_H
